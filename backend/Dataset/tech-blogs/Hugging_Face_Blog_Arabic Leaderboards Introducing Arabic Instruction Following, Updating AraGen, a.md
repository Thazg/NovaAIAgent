...
URL Source: https://huggingface.co/blog/leaderboard-3c3h-aragen-ifeval

Published Time: 2025-04-08T00:00:00.555Z
...
[![Image 2: Sarah AlBarri's avatar](https://huggingface.co/avatars/c71a54d7c9824d17ab4ad3deaf33afd1.svg)](https://huggingface.co/SarahAlBarri)
...
[![Image 4: samta kamboj's avatar](https://huggingface.co/avatars/9b3b2d12ad3e1959aacfefbb931986dd.svg)](https://huggingface.co/samta-kamboj)

[![Image 5: Neha Sengupta's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/6429100588215cee63b9334e/L5-CPVDsIC_1mI_izizyX.jpeg)](https://huggingface.co/neha1710)

[![Image 6: Preslav Nakov's avatar](https://huggingface.co/avatars/cc9c6210fdc822d8a106937e747dff41.svg)](https://huggingface.co/preslavnakov)
...
## [](https://huggingface.co/blog/leaderboard-3c3h-aragen-ifeval#arabic-leaderboards-space) Arabic-Leaderboards Space
...
## [](https://huggingface.co/blog/leaderboard-3c3h-aragen-ifeval#latest-updates-in-aragen-leaderboard) Latest Updates in AraGen Leaderboard
...
### [](https://huggingface.co/blog/leaderboard-3c3h-aragen-ifeval#aragen-03-25-release) AraGen-03-25 Release
...
![Image 7: Tasks Distribution (%)](https://huggingface.co/spaces/inceptionai/Arabic-Leaderboards/raw/main/assets/pictures/03-25/PercentageDistributionOfTasks.png)

Additionally, we refined the **judge system prompt** to enhance clarity, even for smaller/weaker judge models.

### [](https://huggingface.co/blog/leaderboard-3c3h-aragen-ifeval#dynamic-evaluation-and-ranking-analysis) Dynamic Evaluation and Ranking Analysis
...
#### [](https://huggingface.co/blog/leaderboard-3c3h-aragen-ifeval#analysis-of-ranking-changes) Analysis of Ranking Changes
...
The overall rankings were stable, with the top-performing model (_o1-2024-12-17_) consistently maintaining its lead. Notably, we observed a swap in rankings between two Claude models, underscoring the sensitivity of our evaluation approach, especially given their initially close scores.

The only significant change in rankings was for the _gpt-4o-2024-08-06_ model, whose performance markedly improved with the updated dataset and prompt. This sudden jump is currently under investigation as part of our ongoing benchmarks-design research.

No major variations occurred solely due to changes in the system prompt, indicating good reproducibility as long as the same judge model (_claude-3.5-sonnet_) is used. However, we anticipate potential variations with smaller or weaker models as judges, where employing the second system prompt (SP2) may enhance consistency.

As a summary, the robust, consistently top-ranking performance of _o1-2024-12-17_—whose top score dropped from 82.67% to 70.25%—continues to reinforce its reliability for Arabic applications under the more challenging updated benchmark. While recent updates to the evaluation pipeline introduced minor ranking shifts, the overall framework remained stable, with top and bottom performers showing consistent positions. Many observed ranking adjustments likely reflect typical evaluation error margins due to minor score differences. Notably, scores for the second- through fifth-ranked models, previously between 70–78%, are now between 51–57%. This highlights that the updated AraGen dataset poses a markedly more difficult benchmark aligned with ongoing advances in reasoning models. Despite these shifts in absolute scores, it is encouraging that leaderboard positions remained largely consistent, underscoring the robustness of the evaluation approach moving forward.

More Detailed Scores
###### [](https://huggingface.co/blog/leaderboard-3c3h-aragen-ifeval#couple-1-system-prompt-effect-aragen-03-25-sp1-vs-aragen-03-25-sp2) Couple 1: System Prompt Effect (AraGen-03-25 SP1 vs. AraGen-03-25 SP2)
...
###### [](https://huggingface.co/blog/leaderboard-3c3h-aragen-ifeval#couple-2-dataset-and-prompt-update-effect-aragen-12-24-sp1-old-vs-aragen-03-25-sp2-new) Couple 2: Dataset and Prompt Update Effect (AraGen-12-24 SP1 (old) vs. AraGen-03-25 SP2 (new))
...
#### [](https://huggingface.co/blog/leaderboard-3c3h-aragen-ifeval#analysis-of-3c3h) Analysis of 3C3H
...
![Image 8: HeatMap for o1-2024-12-17](https://huggingface.co/spaces/inceptionai/Arabic-Leaderboards/raw/main/assets/pictures/03-25/o1-heatmap.png)
...
![Image 9: SILMA-9B-Instruct-v1.0 VS Gemma-2-9b-it HeatMaps](https://huggingface.co/spaces/inceptionai/Arabic-Leaderboards/raw/main/assets/pictures/03-25/silma-vs-gemma-heatmap.jpeg)
...
## [](https://huggingface.co/blog/leaderboard-3c3h-aragen-ifeval#instruction-following-leaderboard) Instruction Following Leaderboard

### [](https://huggingface.co/blog/leaderboard-3c3h-aragen-ifeval#what-is-instruction-following-as-a-benchmark) What is Instruction Following as a Benchmark?
...
### [](https://huggingface.co/blog/leaderboard-3c3h-aragen-ifeval#dataset-arabic-ifeval) Dataset: Arabic IFEval
...
### [](https://huggingface.co/blog/leaderboard-3c3h-aragen-ifeval#evaluation-methodology--metrics) Evaluation Methodology & Metrics
...
### [](https://huggingface.co/blog/leaderboard-3c3h-aragen-ifeval#results--analysis) Results & Analysis
...
## [](https://huggingface.co/blog/leaderboard-3c3h-aragen-ifeval#upcoming-work) Upcoming Work
