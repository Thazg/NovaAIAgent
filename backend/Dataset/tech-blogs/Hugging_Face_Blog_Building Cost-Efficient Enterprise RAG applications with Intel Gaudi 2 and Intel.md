...
URL Source: https://huggingface.co/blog/cost-efficient-rag-applications-with-intel

Published Time: 2024-05-09T00:00:00.384Z

Markdown Content:
[Back to Articles](https://huggingface.co/blog)

[![Image 1: Julien Simon's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/615ad80355a0d1b0f2f15666/fJ0p0s2DmDkw2o8EoNURW.jpeg)](https://huggingface.co/juliensimon)

[![Image 2: Haihao Shen's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/60ac3318e3de7c7440abb850/DkMrPBr6Ew_dS_c9kog4e.jpeg)](https://huggingface.co/Haihao)

[![Image 3: Antony Vance Jeyaraj's avatar](https://huggingface.co/avatars/74955a31d46b5dd87375acd0e916ec7a.svg)](https://huggingface.co/antonyvance)

[![Image 4: Matrix Yao's avatar](https://huggingface.co/avatars/61864d5751bd574a3794206d773eda70.svg)](https://huggingface.co/MatrixYao)

[![Image 5: Leon Lv's avatar](https://huggingface.co/avatars/97dc9e01f11fcaed3e7cd0fb45923b93.svg)](https://huggingface.co/lianglv)

[![Image 6: Greg Serochi's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/1675185830512-noauth.jpeg)](https://huggingface.co/gserochi)

[![Image 7: Deb Bharadwaj's avatar](https://huggingface.co/avatars/064596d8d20cc848e691f195c3b6d067.svg)](https://huggingface.co/Debbh)

[![Image 8: Ke Ding's avatar](https://huggingface.co/avatars/5b6b2ea60d7c70bd2ddcff501aa7981e.svg)](https://huggingface.co/kding1)

![Image 9](https://huggingface.co/blog/assets/cost_efficient_rag_applications_with_intel/main.jpg)
...
## [](https://huggingface.co/blog/cost-efficient-rag-applications-with-intel#getting-started) Getting started
...
![Image 10](https://huggingface.co/blog/assets/cost_efficient_rag_applications_with_intel/01.png)
...
## [](https://huggingface.co/blog/cost-efficient-rag-applications-with-intel#creating-the-vector-database) Creating the Vector Database
...
## [](https://huggingface.co/blog/cost-efficient-rag-applications-with-intel#defining-the-rag-pipeline) Defining the RAG Pipeline
...
## [](https://huggingface.co/blog/cost-efficient-rag-applications-with-intel#loading-the-llm-on-gaudi-2) Loading the LLM on Gaudi 2
...
## [](https://huggingface.co/blog/cost-efficient-rag-applications-with-intel#running-the-rag-service) Running the RAG service
...
## [](https://huggingface.co/blog/cost-efficient-rag-applications-with-intel#launching-the-rag-gui) Launching the RAG GUI
...
![Image 11](https://huggingface.co/blog/assets/cost_efficient_rag_applications_with_intel/02.png)

## [](https://huggingface.co/blog/cost-efficient-rag-applications-with-intel#benchmark-results) Benchmark Results
...
![Image 12](https://huggingface.co/blog/assets/cost_efficient_rag_applications_with_intel/03.png)![Image 13](https://huggingface.co/blog/assets/cost_efficient_rag_applications_with_intel/04.png)
...
## [](https://huggingface.co/blog/cost-efficient-rag-applications-with-intel#conclusion) Conclusion
