...
URL Source: https://huggingface.co/blog/intel-fast-embedding

Published Time: 2024-03-15T00:00:00.352Z

Markdown Content:
[Back to Articles](https://huggingface.co/blog)

[![Image 1: Peter Izsak's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/605714b1861b9d53d9c4b8db/5kpnfrvnIKRBjmQsMJKk-.jpeg)](https://huggingface.co/peterizsak)

[![Image 2: Moshe Berchansky's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/63e0c8875c6964861ebb0c49/yzkhPSxgXtJCM62iMBOOK.jpeg)](https://huggingface.co/mber)

[![Image 3: Daniel Fleischer's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/62d93cd728f9c86a4031562e/ix_LD-wjW8vCltosCVUmV.jpeg)](https://huggingface.co/danf)

[![Image 4: Ella Charlaix's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/6050eb5aeb94f56898c08e57/FBDyc4s4mVTmFYfR4Jcng.jpeg)](https://huggingface.co/echarlaix)

[![Image 5: Morgan Funtowicz's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/1583858935715-5e67c47c100906368940747e.jpeg)](https://huggingface.co/mfuntowicz)

[![Image 6: Moshe Wasserblat's avatar](https://huggingface.co/avatars/e05ca715004b39e79472399f75010bda.svg)](https://huggingface.co/moshew)
...
## [](https://huggingface.co/blog/intel-fast-embedding#information-retrieval-with-embedding-models) Information Retrieval with Embedding Models
...
### [](https://huggingface.co/blog/intel-fast-embedding#embedding-models-and-rag) Embedding models and RAG
...
## [](https://huggingface.co/blog/intel-fast-embedding#optimizing-embedding-models-with-optimum-intel-and-ipex) Optimizing Embedding Models with Optimum Intel and IPEX
...
## [](https://huggingface.co/blog/intel-fast-embedding#example-optimizing-bge-embedding-models) Example: Optimizing BGE Embedding Models
...
### [](https://huggingface.co/blog/intel-fast-embedding#bge-technical-details) BGE Technical Details
...
### [](https://huggingface.co/blog/intel-fast-embedding#step-by-step-optimization-by-quantization) Step-by-step: Optimization by Quantization
...
##### [](https://huggingface.co/blog/intel-fast-embedding#step-1-installing-packages) Step 1: Installing Packages
...
##### [](https://huggingface.co/blog/intel-fast-embedding#step-2-post-training-static-quantization) Step 2: Post-training Static Quantization
...
##### [](https://huggingface.co/blog/intel-fast-embedding#step-3-loading-and-running-inference) Step 3: Loading and running inference
...
### [](https://huggingface.co/blog/intel-fast-embedding#model-evaluation-with-mteb) Model Evaluation with MTEB
...
|  | Reranking | Retrieval |
| --- | --- | --- |
| | | | --- | | BGE-small | | BGE-base | | BGE-large | | | int8 | fp32 | diff | | --- | --- | --- | | 0.5826 | 0.5836 | -0.17% | | 0.5886 | 0.5886 | 0% | | 0.5985 | 0.6003 | -0.3% | | | int8 | fp32 | diff | | --- | --- | --- | | 0.5138 | 0.5168 | -0.58% | | 0.5242 | 0.5325 | -1.55% | | 0.5346 | 0.5429 | -1.53% | |

### [](https://huggingface.co/blog/intel-fast-embedding#speed-and-latency) Speed and Latency
...
### [](https://huggingface.co/blog/intel-fast-embedding#how-did-we-run-the-evaluation) How did we run the evaluation?
...
1.   Optimum Intel with IPEX and `int8` model:
...
### [](https://huggingface.co/blog/intel-fast-embedding#latency-performance) Latency performance
...
![Image 7: latency](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/178_intel_ipex_quantization/latency.png)

_Figure 1. Latency for BGE models._

### [](https://huggingface.co/blog/intel-fast-embedding#throughput-performance) Throughput Performance
...
![Image 8: throughput small](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/178_intel_ipex_quantization/throughput_small.png)

_Figure 2. Throughput for BGE small._

![Image 9: throughput base](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/178_intel_ipex_quantization/throughput_base.png)

_Figure 3. Throughput for BGE base._

![Image 10: throughput large](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/178_intel_ipex_quantization/throughput_large.png)

_Figure 4. Throughput for BGE large._

## [](https://huggingface.co/blog/intel-fast-embedding#optimized-embedding-models-with-fastrag) Optimized Embedding Models with fastRAG

[![Image 11](https://github.com/IntelLabs/fastRAG/raw/main/assets/fastrag_header.png)](https://github.com/IntelLabs/fastRAG/)
...
### [](https://huggingface.co/blog/intel-fast-embedding#fast-indexing-using-the-optimized-retriever) Fast indexing using the optimized Retriever
...
### [](https://huggingface.co/blog/intel-fast-embedding#reranking-using-the-optimized-ranker) Reranking using the Optimized Ranker
...
Done! The created pipeline can be used to retrieve documents from a document store and rank the retrieved documents using (another) embedding models to re-order the documents. A more complete example is provided in this [notebook](https://github.com/IntelLabs/fastRAG/blob/main/examples/optimized-embeddings.ipynb).
