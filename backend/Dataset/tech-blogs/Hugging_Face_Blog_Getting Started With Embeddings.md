...
URL Source: https://huggingface.co/blog/getting-started-with-embeddings
...
[![Image 1: Omar Espejel's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/60c5394afcb103f4f6a53c59/RNC-zezv1FolR5gVq5qSh.jpeg)](https://huggingface.co/espejelomar)
...
*   [Additional resources to keep learning](https://huggingface.co/blog/getting-started-with-embeddings#additional-resources-to-keep-learning "Additional resources to keep learning")
    *   [Training and advanced techniques](https://huggingface.co/blog/getting-started-with-embeddings#training-and-advanced-techniques "Training and advanced techniques")

Check out this tutorial with the Notebook Companion: [![Image 2: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/huggingface/blog/blob/main/notebooks/80_getting_started_with_embeddings.ipynb)
...
[![Image 3](https://huggingface.co/blog/assets/80_getting_started_with_embeddings/SelectDataset.png)](https://huggingface.co/blog/assets/80_getting_started_with_embeddings/SelectDataset.png)
...
[![Image 4](https://huggingface.co/blog/assets/80_getting_started_with_embeddings/createDataset.png)](https://huggingface.co/blog/assets/80_getting_started_with_embeddings/createDataset.png)

*   Go to the "Files" tab (screenshot below) and click "Add file" and "Upload file."

[![Image 5](https://huggingface.co/blog/assets/80_getting_started_with_embeddings/AddFile.png)](https://huggingface.co/blog/assets/80_getting_started_with_embeddings/AddFile.png)

*   Finally, drag or upload the dataset, and commit the changes.

[![Image 6](https://huggingface.co/blog/assets/80_getting_started_with_embeddings/UploadFile.png)](https://huggingface.co/blog/assets/80_getting_started_with_embeddings/UploadFile.png)
...
### [](https://huggingface.co/blog/getting-started-with-embeddings#training-and-advanced-techniques) Training and advanced techniques
