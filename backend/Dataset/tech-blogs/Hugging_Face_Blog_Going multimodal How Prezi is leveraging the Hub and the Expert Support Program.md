...
URL Source: https://huggingface.co/blog/prezi-case-study

Published Time: 2024-06-19T00:00:00.410Z

Markdown Content:
[Back to Articles](https://huggingface.co/blog)

[![Image 1: Violette's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/1638698875017-noauth.jpeg)](https://huggingface.co/Violette)
...
[![Image 3: Moritz Borrett-Laurer (formerly Laurer)'s avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/1613511937628-5fb15d1e84389b139cf3b508.jpeg)](https://huggingface.co/MoritzLaurer)

[![Image 4: Máté Börcsök's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/64a58f5b6c0223510c60f9e8/TTkQwFdhz_CDMP4PfIJ5C.jpeg)](https://huggingface.co/bmateusz)

*   [Transcript with additional details:](https://huggingface.co/blog/prezi-case-study#transcript-with-additional-details "Transcript with additional details:")
    *   [Introduction](https://huggingface.co/blog/prezi-case-study#introduction "Introduction")

    *   [How does the HF Expert Support Program help you build AI?](https://huggingface.co/blog/prezi-case-study#how-does-the-hf-expert-support-program-help-you-build-ai "How does the HF Expert Support Program help you build AI?")

    *   [What’s your favorite feature of Inference Endpoints?](https://huggingface.co/blog/prezi-case-study#whats-your-favorite-feature-of-inference-endpoints "What’s your favorite feature of Inference Endpoints?")

    *   [What teams would benefit most from Expert Support?](https://huggingface.co/blog/prezi-case-study#what-teams-would-benefit-most-from-expert-support "What teams would benefit most from Expert Support?")
...
## [](https://huggingface.co/blog/prezi-case-study#transcript-with-additional-details) Transcript with additional details:

### [](https://huggingface.co/blog/prezi-case-study#introduction) Introduction

My name is Máté, and I am a backend engineer at Prezi, an online presentation tool that brings your ideas to life.

### [](https://huggingface.co/blog/prezi-case-study#how-does-the-hf-expert-support-program-help-you-build-ai) How does the HF Expert Support Program help you build AI?
...
### [](https://huggingface.co/blog/prezi-case-study#whats-your-favorite-feature-of-inference-endpoints) What’s your favorite feature of Inference Endpoints?
...
### [](https://huggingface.co/blog/prezi-case-study#what-teams-would-benefit-most-from-expert-support) What teams would benefit most from Expert Support?
