...
URL Source: https://huggingface.co/blog/argilla-chatbot

Published Time: 2024-07-16T00:00:00.425Z

Markdown Content:
[Back to Articles](https://huggingface.co/blog)

[![Image 1: Agustín Piqueres Lajarín's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/6435d564a4bd75c62cc03701/7P2G_wVNB6MISp2Phh427.jpeg)](https://huggingface.co/plaguss)

[![Image 2: Gabriel Martín Blázquez's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/60f2fc91b92afccb7c34b8ed/W2-Nay12Ef4Ltyaf8EKE9.jpeg)](https://huggingface.co/gabrielmbmb)

[![Image 3: Sara Han Díaz's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/6420817bf837b31c1cfced50/09dhIVj9WNgs55PdWgHGo.jpeg)](https://huggingface.co/sdiazlor)

[![Image 4: Omar Sanseviero's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/6032802e1f993496bc14d9e3/w6hr-DEQot4VVkoyRIBiy.png)](https://huggingface.co/osanseviero)

[![Image 5: Daniel Vila's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/60420dccc15e823a685f2b03/AOApMWt_jvm9e6XQ2vlrJ.jpeg)](https://huggingface.co/dvilasuero)

## *   [TL;DR](https://huggingface.co/blog/argilla-chatbot#tldr "TL;DR")

*   [Table of Contents](https://huggingface.co/blog/argilla-chatbot#table-of-contents "Table of Contents")

*   [Generating Synthetic Data for Fine-Tuning Custom Embedding Models](https://huggingface.co/blog/argilla-chatbot#generating-synthetic-data-for-fine-tuning-custom-embedding-models "Generating Synthetic Data for Fine-Tuning Custom Embedding Models")
    *   [Downloading and chunking data](https://huggingface.co/blog/argilla-chatbot#downloading-and-chunking-data "Downloading and chunking data")

    *   [Generating synthetic data for our embedding model using distilabel](https://huggingface.co/blog/argilla-chatbot#generating-synthetic-data-for-our-embedding-model-using-distilabel "Generating synthetic data for our embedding model using distilabel")

    *   [Explore the datasets in Argilla](https://huggingface.co/blog/argilla-chatbot#explore-the-datasets-in-argilla "Explore the datasets in Argilla")

    *   [Fine-Tune the embedding model](https://huggingface.co/blog/argilla-chatbot#fine-tune-the-embedding-model "Fine-Tune the embedding model")

*   [The vector database](https://huggingface.co/blog/argilla-chatbot#the-vector-database "The vector database")
    *   [Connect to the database](https://huggingface.co/blog/argilla-chatbot#connect-to-the-database "Connect to the database")

    *   [Create the table with the documentation chunks](https://huggingface.co/blog/argilla-chatbot#create-the-table-with-the-documentation-chunks "Create the table with the documentation chunks")

*   [Creating our ChatBot](https://huggingface.co/blog/argilla-chatbot#creating-our-chatbot "Creating our ChatBot")
    *   [The Gradio App](https://huggingface.co/blog/argilla-chatbot#the-gradio-app "The Gradio App")

    *   [Deploy the ChatBot app on Hugging Face Spaces](https://huggingface.co/blog/argilla-chatbot#deploy-the-chatbot-app-on-hugging-face-spaces "Deploy the ChatBot app on Hugging Face Spaces")

    *   [Playing around with our ChatBot](https://huggingface.co/blog/argilla-chatbot#playing-around-with-our-chatbot "Playing around with our ChatBot")

*   [Next steps](https://huggingface.co/blog/argilla-chatbot#next-steps "Next steps")

[](https://huggingface.co/blog/argilla-chatbot#tldr) TL;DR
...
[](https://huggingface.co/spaces/plaguss/argilla-sdk-chatbot-space)[![Image 6: chatbot img](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/argilla-chatbot/chatbot.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/argilla-chatbot/chatbot.png)

## [](https://huggingface.co/blog/argilla-chatbot#table-of-contents) Table of Contents

*   [Generating Synthetic Data for Fine-Tuning a domain-specific Embedding Models](https://huggingface.co/blog/argilla-chatbot#generating-synthetic-data-for-fine-tuning-domain-specific-embedding-models)
*   [Downloading and chunking data](https://huggingface.co/blog/argilla-chatbot#downloading-and-chunking-data)
*   [Generating synthetic data for our embedding model using distilabel](https://huggingface.co/blog/argilla-chatbot#generating-synthetic-data-for-our-embedding-model-using-distilabel)
*   [Explore the datasets in Argilla](https://huggingface.co/blog/argilla-chatbot#explore-the-datasets-in-argilla)
    *   [An Argilla dataset with chunks of technical documentation](https://huggingface.co/blog/argilla-chatbot#an-argilla-dataset-with-chunks-of-technical-documentation)
    *   [An Argilla dataset with triplets to fine tune an embedding model](https://huggingface.co/blog/argilla-chatbot#an-argilla-dataset-with-triplets-to-fine-tune-an-embedding-model)
    *   [An Argilla dataset to track the chatbot conversations](https://huggingface.co/blog/argilla-chatbot#an-argilla-dataset-to-track-the-chatbot-conversations)

*   [Fine-Tune the embedding model](https://huggingface.co/blog/argilla-chatbot#fine-tune-the-embedding-model)
    *   [Prepare the embedding dataset](https://huggingface.co/blog/argilla-chatbot#prepare-the-embedding-dataset)
    *   [Load the baseline model](https://huggingface.co/blog/argilla-chatbot#load-the-baseline-model)
    *   [Define the loss function](https://huggingface.co/blog/argilla-chatbot#define-the-loss-function)
    *   [Define the training strategy](https://huggingface.co/blog/argilla-chatbot#define-the-training-strategy)
    *   [Train and save the final model](https://huggingface.co/blog/argilla-chatbot#train-and-save-the-final-model)

*   [The vector database](https://huggingface.co/blog/argilla-chatbot#the-vector-database)
*   [Connect to the database](https://huggingface.co/blog/argilla-chatbot#connect-to-the-database)
    *   [Instantiate the fine-tuned model](https://huggingface.co/blog/argilla-chatbot#instantiate-the-fine-tuned-model)

*   [Create the table with the documentation chunks](https://huggingface.co/blog/argilla-chatbot#create-the-table-with-the-documentation-chunks)
    *   [Populate the table](https://huggingface.co/blog/argilla-chatbot#populate-the-table)
    *   [Store the database in the Hugging Face Hub](https://huggingface.co/blog/argilla-chatbot#store-the-database-in-the-hugging-face-hub)

*   [Creating our ChatBot](https://huggingface.co/blog/argilla-chatbot#creating-our-chatbot)
*   [The Gradio App](https://huggingface.co/blog/argilla-chatbot#the-gradio-app)
*   [Deploy the ChatBot app on Hugging Face Spaces](https://huggingface.co/blog/argilla-chatbot#deploy-the-chatbot-app-on-hugging-face-spaces)
*   [Playing around with our ChatBot](https://huggingface.co/blog/argilla-chatbot#playing-around-with-our-chatbot)
*   [Next steps](https://huggingface.co/blog/argilla-chatbot#next-steps)

## [](https://huggingface.co/blog/argilla-chatbot#generating-synthetic-data-for-fine-tuning-custom-embedding-models) Generating Synthetic Data for Fine-Tuning Custom Embedding Models
...
### [](https://huggingface.co/blog/argilla-chatbot#downloading-and-chunking-data) Downloading and chunking data
...
### [](https://huggingface.co/blog/argilla-chatbot#generating-synthetic-data-for-our-embedding-model-using-distilabel) Generating synthetic data for our embedding model using distilabel
...
### [](https://huggingface.co/blog/argilla-chatbot#explore-the-datasets-in-argilla) Explore the datasets in Argilla
...
#### [](https://huggingface.co/blog/argilla-chatbot#an-argilla-dataset-with-chunks-of-technical-documentation) An Argilla dataset with chunks of technical documentation
...
Now, let's retrieve the dataset we created earlier from the Hugging Face Hub. Recall the dataset we generated in the [chunking data section](https://huggingface.co/blog/argilla-chatbot#downloading-and-chunking-data)? We'll download that dataset and extract the essential columns we need to move forward:
...
[![Image 7: argilla-img-1](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/argilla-chatbot/argilla-img-1.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/argilla-chatbot/argilla-img-1.png)

#### [](https://huggingface.co/blog/argilla-chatbot#an-argilla-dataset-with-triplets-to-fine-tune-an-embedding-model) An Argilla dataset with triplets to fine-tune an embedding model

Now, we can repeat the process with the dataset ready for fine-tuning we generated in the [previous section](https://huggingface.co/blog/argilla-chatbot#generating-synthetic-data-for%E2%80%93our-embedding-model:-distilabel-to-the-rescue). Fortunately, the process is straightforward: simply download the relevant dataset and upload it to Argilla with its designated name. For a detailed walkthrough, refer to the Jupyter notebook, which contains all the necessary instructions:
...
[![Image 8: argilla-img-2](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/argilla-chatbot/argilla-img-2.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/argilla-chatbot/argilla-img-2.png)
...
#### [](https://huggingface.co/blog/argilla-chatbot#an-argilla-dataset-to-track-the-chatbot-conversations) An Argilla dataset to track the chatbot conversations

Now, let's create our final dataset, which will be dedicated to tracking user interactions with our chatbot. _Note_: You may want to revisit this section after completing the Gradio app, as it will provide a more comprehensive understanding of the context. For now, let's take a look at the `Settings` for this dataset:
...
[![Image 9: argilla-img-3](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/argilla-chatbot/argilla-img-3.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/argilla-chatbot/argilla-img-3.png)
...
### [](https://huggingface.co/blog/argilla-chatbot#fine-tune-the-embedding-model) Fine-Tune the embedding model
...
#### [](https://huggingface.co/blog/argilla-chatbot#prepare-the-embedding-dataset) Prepare the embedding dataset
...
#### [](https://huggingface.co/blog/argilla-chatbot#load-the-baseline-model) Load the baseline model
...
#### [](https://huggingface.co/blog/argilla-chatbot#define-the-loss-function) Define the loss function
...
#### [](https://huggingface.co/blog/argilla-chatbot#define-the-training-strategy) Define the training strategy
...
#### [](https://huggingface.co/blog/argilla-chatbot#train-and-save-the-final-model) Train and save the final model
...
## [](https://huggingface.co/blog/argilla-chatbot#the-vector-database) The vector database
...
### [](https://huggingface.co/blog/argilla-chatbot#connect-to-the-database) Connect to the database
...
#### [](https://huggingface.co/blog/argilla-chatbot#instantiate-the-fine-tuned-model) Instantiate the fine-tuned model
...
### [](https://huggingface.co/blog/argilla-chatbot#create-the-table-with-the-documentation-chunks) Create the table with the documentation chunks
...
#### [](https://huggingface.co/blog/argilla-chatbot#populate-the-table) Populate the table
...
#### [](https://huggingface.co/blog/argilla-chatbot#store-the-database-in-the-hugging-face-hub) Store the database in the Hugging Face Hub
...
## [](https://huggingface.co/blog/argilla-chatbot#creating-our-chatbot) Creating our ChatBot

All the pieces are ready for our chatbot; we need to connect them and make them available in an interface.

### [](https://huggingface.co/blog/argilla-chatbot#the-gradio-app) The Gradio App
...
[![Image 10: chatty](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/argilla-chatbot/img_1.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/argilla-chatbot/img_1.png)
...
### [](https://huggingface.co/blog/argilla-chatbot#deploy-the-chatbot-app-on-hugging-face-spaces) Deploy the ChatBot app on Hugging Face Spaces
...
### [](https://huggingface.co/blog/argilla-chatbot#playing-around-with-our-chatbot) Playing around with our ChatBot
...
[![Image 11: chatbot img](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/argilla-chatbot/chatbot.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/argilla-chatbot/chatbot.png)

But that's not all! You can also challenge our chatbot to generate settings for a specific dataset, like the one we created earlier in this tutorial. For example, you could ask it to suggest settings for a dataset designed to fine-tune an embedding model, similar to the one we explored in the [An Argilla dataset with triplets to fine-tune an embedding model](https://huggingface.co/blog/argilla-chatbot#an-A:rgilla-dataset-with-triplets-to-fine-tune-an-embedding-model) section.

Take a look at the screenshot below to see how our chatbot responds to this type of query.

[![Image 12: chatbot sentence-embedding](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/argilla-chatbot/chatbot-sentence-embeddings.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/argilla-chatbot/chatbot-sentence-embeddings.png)

Go ahead, ask your questions, and see what insights our chatbot can provide!

## [](https://huggingface.co/blog/argilla-chatbot#next-steps) Next steps
