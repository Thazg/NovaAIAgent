...
URL Source: https://huggingface.co/blog/rteb

Published Time: 2025-10-01T00:00:00.636Z
...
## [](https://huggingface.co/blog/rteb#why-existing-benchmarks-fall-short) Why Existing Benchmarks Fall Short
...
Because of the above, models with a lower zero-shot score[[1]](https://huggingface.co/blog/rteb#footnote-1) may perform very well on the benchmark, without generalizing to new problems. For this reason, models with slightly lower benchmark performance and a higher zero-shot score are often recommended instead.

![Image 8](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/rteb/mteb-zero-shot-models.png)

From [Chung et al. (2025)](https://arxiv.org/abs/2506.21182)
...
## [](https://huggingface.co/blog/rteb#introducing-rteb) Introducing RTEB
...
### [](https://huggingface.co/blog/rteb#a-hybrid-strategy-for-true-generalization) A Hybrid Strategy for True Generalization
...
### [](https://huggingface.co/blog/rteb#built-for-real-world-domains) Built for Real-World Domains
...
RTEB Datasets
#### [](https://huggingface.co/blog/rteb#open) Open
...
#### [](https://huggingface.co/blog/rteb#closed) Closed
...
## [](https://huggingface.co/blog/rteb#launching-rteb-a-community-effort) Launching RTEB: A Community Effort
...
## [](https://huggingface.co/blog/rteb#limitations-and-future-work) Limitations and Future Work
