...
URL Source: https://huggingface.co/blog/sagemaker-huggingface-embedding

Published Time: 2024-06-07T00:00:00.404Z
...
[![Image 2: Jeff Boudier's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/1605114051380-noauth.jpeg)](https://huggingface.co/jeffboudier)

*   [What is the Hugging Face Embedding Container?](https://huggingface.co/blog/sagemaker-huggingface-embedding#what-is-the-hugging-face-embedding-container "What is the Hugging Face Embedding Container?")

*   [1. Setup development environment](https://huggingface.co/blog/sagemaker-huggingface-embedding#1-setup-development-environment "1. Setup development environment")

*   [2. Retrieve the new Hugging Face Embedding Container](https://huggingface.co/blog/sagemaker-huggingface-embedding#2-retrieve-the-new-hugging-face-embedding-container "2. Retrieve the new Hugging Face Embedding Container")

*   [3. Deploy Snowflake Arctic to Amazon SageMaker](https://huggingface.co/blog/sagemaker-huggingface-embedding#3-deploy-snowflake-arctic-to-amazon-sagemaker "3. Deploy Snowflake Arctic to Amazon SageMaker")

*   [4. Run and evaluate Inference performance](https://huggingface.co/blog/sagemaker-huggingface-embedding#4-run-and-evaluate-inference-performance "4. Run and evaluate Inference performance")

*   [5. Delete model and endpoint](https://huggingface.co/blog/sagemaker-huggingface-embedding#5-delete-model-and-endpoint "5. Delete model and endpoint")

*   [Conclusion](https://huggingface.co/blog/sagemaker-huggingface-embedding#conclusion "Conclusion")
...
*   [1. Setup development environment](https://huggingface.co/blog/sagemaker-huggingface-embedding#1-setup-development-environment)
*   [2. Retrieve the new Hugging Face Embedding Container](https://huggingface.co/blog/sagemaker-huggingface-embedding#2-retrieve-the-new-hugging-face-embedding-container)
*   [3. Deploy Snowflake Arctic to Amazon SageMaker](https://huggingface.co/blog/sagemaker-huggingface-embedding#3-deploy-snowflake-arctic-to-amazon-sagemaker)
*   [4. Run and evaluate Inference performance](https://huggingface.co/blog/sagemaker-huggingface-embedding#4-run-and-evaluate-inference-performance)
*   [5. Delete model and endpoint](https://huggingface.co/blog/sagemaker-huggingface-embedding#5-delete-model-and-endpoint)

## [](https://huggingface.co/blog/sagemaker-huggingface-embedding#what-is-the-hugging-face-embedding-container) What is the Hugging Face Embedding Container?
...
## [](https://huggingface.co/blog/sagemaker-huggingface-embedding#1-setup-development-environment) 1. Setup development environment
...
## [](https://huggingface.co/blog/sagemaker-huggingface-embedding#2-retrieve-the-new-hugging-face-embedding-container) 2. Retrieve the new Hugging Face Embedding Container
...
## [](https://huggingface.co/blog/sagemaker-huggingface-embedding#3-deploy-snowflake-arctic-to-amazon-sagemaker) 3. Deploy Snowflake Arctic to Amazon SageMaker
...
## [](https://huggingface.co/blog/sagemaker-huggingface-embedding#4-run-and-evaluate-inference-performance) 4. Run and evaluate Inference performance
...
[![Image 3: cw](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/cw.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/cw.png)

## [](https://huggingface.co/blog/sagemaker-huggingface-embedding#5-delete-model-and-endpoint) 5. Delete model and endpoint
...
## [](https://huggingface.co/blog/sagemaker-huggingface-embedding#conclusion) Conclusion
