...
URL Source: https://huggingface.co/blog/leaderboard-3c3h-aragen

Published Time: 2024-12-04T00:00:00.491Z

Markdown Content:
[Back to Articles](https://huggingface.co/blog)

[![Image 1: Ali El Filali's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/626237d9bbcbd1c34f1bb231/EJrOjvAL-68qMCYdnvOrq.png)](https://huggingface.co/alielfilali01)

[![Image 2: Neha Sengupta's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/6429100588215cee63b9334e/L5-CPVDsIC_1mI_izizyX.jpeg)](https://huggingface.co/neha1710)

[![Image 3: Abouelseoud's avatar](https://huggingface.co/avatars/c12168cdda7085eb8d649e63115a82b5.svg)](https://huggingface.co/Arwa88)

[![Image 4: Preslav Nakov's avatar](https://huggingface.co/avatars/cc9c6210fdc822d8a106937e747dff41.svg)](https://huggingface.co/preslavnakov)

[![Image 5: Clémentine Fourrier's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/1644340617257-noauth.png)](https://huggingface.co/clefourrier)
...
## [](https://huggingface.co/blog/leaderboard-3c3h-aragen#summary) Summary
...
## [](https://huggingface.co/blog/leaderboard-3c3h-aragen#aragen-a-generative-benchmark-and-leaderboard-for-arabic-llms) AraGen: A Generative Benchmark and Leaderboard for Arabic LLMs
...
## [](https://huggingface.co/blog/leaderboard-3c3h-aragen#the-aragen-leaderboard) The AraGen Leaderboard

### [](https://huggingface.co/blog/leaderboard-3c3h-aragen#evaluation-pipeline) Evaluation Pipeline
...
### [](https://huggingface.co/blog/leaderboard-3c3h-aragen#3c3h-our-new-evaluation-measure-for-llms) 3C3H: Our new evaluation measure for LLMs

Our main contribution, the **3C3H** measure, evaluates model performance across six dimensions, using an LLM-judge

1.   **Correctness (0 or 1)**: Is the answer factually accurate _with respect to_ the ground truth? 
...
#### [](https://huggingface.co/blog/leaderboard-3c3h-aragen#scoring-and-normalization) Scoring and Normalization
...
#### [](https://huggingface.co/blog/leaderboard-3c3h-aragen#calculate-the-3c3h-score) Calculate the 3C3H Score

Given the individual scores for each dimension, the 3C3H measure is computed as follows:

$$
3 C 3 H = \frac{1}{6 n} \sum_{i = 1}^{n} c_{1 i} \left(\right. 1 + c_{2 i} + \frac{c_{3 i} - 1}{4} + \frac{h_{1 i} - 1}{4} + \frac{h_{2 i} - 1}{4} + \frac{h_{3 i} - 1}{4} \left.\right)
$$

Where $n$ is the number of dataset samples, $c_{1 i}$ the correctness score of sample $i$, $c_{2 i}$ the completeness score of sample $i$, and $c_{3 i}$, $h_{1 i}$, $h_{2 i}$, $h_{3 i}$ the Conciseness, Helpfulness, Honesty, and Harmlessness scores respectively of sample $i$.

### [](https://huggingface.co/blog/leaderboard-3c3h-aragen#dynamic-leaderboard-for-robustness) Dynamic Leaderboard for Robustness
...
### [](https://huggingface.co/blog/leaderboard-3c3h-aragen#dataset-design) Dataset Design
...
![Image 6: Percentage Distribution of Tasks](https://huggingface.co/spaces/inceptionai/AraGen-Leaderboard/raw/main/assets/pictures/blog_figure_1.png)

Figure 1: Percentage Distribution of Tasks

![Image 7: Category Distribution for Question Answering (QA)](https://huggingface.co/spaces/inceptionai/AraGen-Leaderboard/raw/main/assets/pictures/blog_figure_2.png)

Figure 2: Category Distribution for Question Answering (QA)

![Image 8: Category Distribution for Reasoning](https://huggingface.co/spaces/inceptionai/AraGen-Leaderboard/raw/main/assets/pictures/blog_figure_3.png)
...
#### [](https://huggingface.co/blog/leaderboard-3c3h-aragen#interaction-categories) Interaction Categories
...
#### [](https://huggingface.co/blog/leaderboard-3c3h-aragen#weighting-system-for-follow-up-interactions) Weighting System for Follow-Up Interactions
...
## [](https://huggingface.co/blog/leaderboard-3c3h-aragen#judge-evaluation-and-selection) Judge Evaluation and Selection
...
#### [](https://huggingface.co/blog/leaderboard-3c3h-aragen#judges-considered) Judges Considered:
...
#### [](https://huggingface.co/blog/leaderboard-3c3h-aragen#evaluation-objectives) Evaluation Objectives
...
### [](https://huggingface.co/blog/leaderboard-3c3h-aragen#agreement-with-human-as-a-judge) Agreement with Human as a Judge
...
![Image 9: Cohen's Kappa Heatmap Representing the Agreement between the Judges on 3C3H Score](https://huggingface.co/spaces/inceptionai/AraGen-Leaderboard/raw/main/assets/pictures/blog_figure_4.png)

Figure 4: Cohen's Kappa Heatmap Representing the Agreement between the Judges on 3C3H Score

#### [](https://huggingface.co/blog/leaderboard-3c3h-aragen#key-observations) Key Observations
...
### [](https://huggingface.co/blog/leaderboard-3c3h-aragen#score-consistency-analysis) Score Consistency Analysis
...
#### [](https://huggingface.co/blog/leaderboard-3c3h-aragen#results) Results
...
#### [](https://huggingface.co/blog/leaderboard-3c3h-aragen#key-observations-1) Key Observations
...
#### [](https://huggingface.co/blog/leaderboard-3c3h-aragen#judge-gpt-4o-mini) Judge: gpt-4o-mini
...
## [](https://huggingface.co/blog/leaderboard-3c3h-aragen#average-standard-deviation-for-judge-gpt-4o-mini-0043604)**Average Standard Deviation for Judge gpt-4o-mini**: 0.043604

#### [](https://huggingface.co/blog/leaderboard-3c3h-aragen#judge-gpt-4o) Judge: gpt-4o
...
## [](https://huggingface.co/blog/leaderboard-3c3h-aragen#average-standard-deviation-for-judge-gpt-4o-002870)**Average Standard Deviation for Judge gpt-4o**: 0.02870

#### [](https://huggingface.co/blog/leaderboard-3c3h-aragen#judge-claude-35-sonnet) Judge: claude-3.5-sonnet
...
## [](https://huggingface.co/blog/leaderboard-3c3h-aragen#average-standard-deviation-for-judge-claude-35-sonnet-000629)**Average Standard Deviation for Judge claude-3.5-sonnet**: 0.00629

#### [](https://huggingface.co/blog/leaderboard-3c3h-aragen#judge-llama31-405b) Judge: llama3.1-405b
...
## [](https://huggingface.co/blog/leaderboard-3c3h-aragen#average-standard-deviation-for-judge-llama31-405b-000915)**Average Standard Deviation for Judge llama3.1-405b**: 0.00915

#### [](https://huggingface.co/blog/leaderboard-3c3h-aragen#judge-jury) Judge: Jury
...
## [](https://huggingface.co/blog/leaderboard-3c3h-aragen#average-standard-deviation-for-judge-jury-000489)**Average Standard Deviation for Judge Jury**: 0.00489

### [](https://huggingface.co/blog/leaderboard-3c3h-aragen#self-bias-analysis) Self Bias Analysis
...
#### [](https://huggingface.co/blog/leaderboard-3c3h-aragen#key-observations-2) Key Observations
...
### [](https://huggingface.co/blog/leaderboard-3c3h-aragen#hallucination-analysis) Hallucination Analysis
...
#### [](https://huggingface.co/blog/leaderboard-3c3h-aragen#quality-validation) Quality Validation
...
#### [](https://huggingface.co/blog/leaderboard-3c3h-aragen#results-1) Results
...
#### [](https://huggingface.co/blog/leaderboard-3c3h-aragen#key-observations-3) Key Observations
...
### [](https://huggingface.co/blog/leaderboard-3c3h-aragen#jury-limitations-and-insights) Jury: Limitations and Insights
...
### [](https://huggingface.co/blog/leaderboard-3c3h-aragen#judge-selection) Judge Selection
...
## [](https://huggingface.co/blog/leaderboard-3c3h-aragen#conclusion) Conclusion
