...
Published Time: 2025-01-15T00:00:00.510Z
...
## [](https://huggingface.co/blog/static-embeddings#tldr) TL;DR
...
[![Image 2: NanoBEIR performance vs inference speed](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/static-embeddings/nano_beir_vs_speed_gpu.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/static-embeddings/nano_beir_vs_speed_gpu.png)

## [](https://huggingface.co/blog/static-embeddings#table-of-contents) Table of Contents

*   [TL;DR](https://huggingface.co/blog/static-embeddings#tl-dr)
*   [Table of Contents](https://huggingface.co/blog/static-embeddings#table-of-contents)
*   [What are Embeddings?](https://huggingface.co/blog/static-embeddings#what-are-embeddings)
    *   [Modern Embeddings](https://huggingface.co/blog/static-embeddings#modern-embeddings)
    *   [Static Embeddings](https://huggingface.co/blog/static-embeddings#static-embeddings)

*   [Our Method](https://huggingface.co/blog/static-embeddings#our-method)
*   [Training Details](https://huggingface.co/blog/static-embeddings#training-details)
    *   [Training Requirements](https://huggingface.co/blog/static-embeddings#training-requirements)
    *   [Model Inspiration](https://huggingface.co/blog/static-embeddings#model-inspiration)
        *   [English Retrieval](https://huggingface.co/blog/static-embeddings#english-retrieval)
        *   [Multilingual Similarity](https://huggingface.co/blog/static-embeddings#multilingual-similarity)

    *   [Training Dataset Selection](https://huggingface.co/blog/static-embeddings#training-dataset-selection)
        *   [English Retrieval](https://huggingface.co/blog/static-embeddings#english-retrieval-1)
        *   [Multilingual Similarity](https://huggingface.co/blog/static-embeddings#multilingual-similarity-1)
        *   [Code](https://huggingface.co/blog/static-embeddings#code)

    *   [Loss Function Selection](https://huggingface.co/blog/static-embeddings#loss-function-selection)
        *   [Code](https://huggingface.co/blog/static-embeddings#code-1)
        *   [Matryoshka Representation Learning](https://huggingface.co/blog/static-embeddings#matryoshka-representation-learning)
            *   [Code](https://huggingface.co/blog/static-embeddings#code-2)

    *   [Training Arguments Selection](https://huggingface.co/blog/static-embeddings#training-arguments-selection)
        *   [Code](https://huggingface.co/blog/static-embeddings#code-3)

    *   [Evaluator Selection](https://huggingface.co/blog/static-embeddings#evaluator-selection)
        *   [Code](https://huggingface.co/blog/static-embeddings#code-4)

    *   [Hardware Details](https://huggingface.co/blog/static-embeddings#hardware-details)
    *   [Overall Training Scripts](https://huggingface.co/blog/static-embeddings#overall-training-scripts)
        *   [English Retrieval](https://huggingface.co/blog/static-embeddings#english-retrieval-2)
        *   [Multilingual Similarity](https://huggingface.co/blog/static-embeddings#multilingual-similarity-2)

*   [Usage](https://huggingface.co/blog/static-embeddings#usage)
    *   [English Retrieval](https://huggingface.co/blog/static-embeddings#english-retrieval-3)
    *   [Multilingual Similarity](https://huggingface.co/blog/static-embeddings#multilingual-similarity-3)
    *   [Matryoshka Dimensionality Truncation](https://huggingface.co/blog/static-embeddings#matryoshka-dimensionality-truncation)
    *   [Third Party libraries](https://huggingface.co/blog/static-embeddings#third-party-libraries)
        *   [LangChain](https://huggingface.co/blog/static-embeddings#langchain)
        *   [LlamaIndex](https://huggingface.co/blog/static-embeddings#llamaindex)
        *   [Haystack](https://huggingface.co/blog/static-embeddings#haystack)
        *   [txtai](https://huggingface.co/blog/static-embeddings#txtai)

*   [Performance](https://huggingface.co/blog/static-embeddings#performance)
    *   [English Retrieval](https://huggingface.co/blog/static-embeddings#english-retrieval-4)
        *   [NanoBEIR](https://huggingface.co/blog/static-embeddings#nanobeir)
            *   [GPU](https://huggingface.co/blog/static-embeddings#gpu)
            *   [CPU](https://huggingface.co/blog/static-embeddings#cpu)

        *   [Matryoshka Evaluation](https://huggingface.co/blog/static-embeddings#matryoshka-evaluation)

    *   [Multilingual Similarity](https://huggingface.co/blog/static-embeddings#multilingual-similarity-4)
        *   [Matryoshka Evaluation](https://huggingface.co/blog/static-embeddings#matryoshka-evaluation-1)

*   [Conclusion](https://huggingface.co/blog/static-embeddings#conclusion)
*   [Next Steps](https://huggingface.co/blog/static-embeddings#next-steps)

## [](https://huggingface.co/blog/static-embeddings#what-are-embeddings) What are Embeddings?
...
[![Image 3: embedding model](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/matryoshka/embedding_model.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/matryoshka/embedding_model.png)
...
[![Image 4: embedding similarity](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/matryoshka/embedding_similarity.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/matryoshka/embedding_similarity.png)
...
### [](https://huggingface.co/blog/static-embeddings#modern-embeddings) Modern Embeddings

Many of today's embedding models consist of a handful of conversion steps. Following these steps is called "inference".

[![Image 5: embedding pipeline](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/static-embeddings/embedding_pipeline.svg)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/static-embeddings/embedding_pipeline.svg)
...
Within this pipeline, the `Encoder` is often a language model with attention layers, which allows each token to be computed within the _context_ of the other tokens. For example, `bank` might be a token, but the token embedding for that token will likely be different if the text refers to a "river bank" or the financial institution.
...
### [](https://huggingface.co/blog/static-embeddings#static-embeddings) Static Embeddings
...
## [](https://huggingface.co/blog/static-embeddings#our-method) Our Method
...
## [](https://huggingface.co/blog/static-embeddings#training-details) Training Details
...
For future research, we leave various other modern training approaches for improving data quality. See [Next Steps](https://huggingface.co/blog/static-embeddings#next-steps) for concrete ideas.

### [](https://huggingface.co/blog/static-embeddings#training-requirements) Training Requirements
...
### [](https://huggingface.co/blog/static-embeddings#model-inspiration) Model Inspiration
...
#### [](https://huggingface.co/blog/static-embeddings#english-retrieval) English Retrieval
...
#### [](https://huggingface.co/blog/static-embeddings#multilingual-similarity) Multilingual Similarity
...
### [](https://huggingface.co/blog/static-embeddings#training-dataset-selection) Training Dataset Selection
...
#### [](https://huggingface.co/blog/static-embeddings#english-retrieval-1) English Retrieval
...
#### [](https://huggingface.co/blog/static-embeddings#multilingual-similarity-1) Multilingual Similarity
...
#### [](https://huggingface.co/blog/static-embeddings#code) Code
...
### [](https://huggingface.co/blog/static-embeddings#loss-function-selection) Loss Function Selection
...
This loss is recommended over MNRL _unless_ you can already fit a large enough batch size in memory with just MNRL. In that case, you can use MNRL to save the 20% training speed cost that CMNRL adds.
...
#### [](https://huggingface.co/blog/static-embeddings#code-1) Code
...
#### [](https://huggingface.co/blog/static-embeddings#matryoshka-representation-learning) Matryoshka Representation Learning
...
### [](https://huggingface.co/blog/static-embeddings#training-arguments-selection) Training Arguments Selection
...
*   `learning_rate`: 2e-1
    *   Note! This is _much_ larger than with normal embedding model training, which often uses a loss around 2e-5.
...
#### [](https://huggingface.co/blog/static-embeddings#code-3) Code
...
### [](https://huggingface.co/blog/static-embeddings#evaluator-selection) Evaluator Selection
...
#### [](https://huggingface.co/blog/static-embeddings#code-4) Code
...
### [](https://huggingface.co/blog/static-embeddings#hardware-details) Hardware Details
...
### [](https://huggingface.co/blog/static-embeddings#overall-training-scripts) Overall Training Scripts
...
#### [](https://huggingface.co/blog/static-embeddings#english-retrieval-2) English Retrieval
...
#### [](https://huggingface.co/blog/static-embeddings#multilingual-similarity-2) Multilingual Similarity
...
## [](https://huggingface.co/blog/static-embeddings#usage) Usage

The usage of these models is very straightforward, identical to the normal Sentence Transformers flow:

### [](https://huggingface.co/blog/static-embeddings#english-retrieval-3) English Retrieval
...
The upcoming [Performance > English Retrieval](https://huggingface.co/blog/static-embeddings#english-retrieval-4) section will show that these results are quite solid, within 15% of commonly used Transformer-based encoder models like [all-mpnet-base-v2](https://huggingface.co/sentence-transformers/all-mpnet-base-v2).
...
### [](https://huggingface.co/blog/static-embeddings#multilingual-similarity-3) Multilingual Similarity
...
This model only loses about 8% of performance compared to the popular but much slower [multilingual-e5-small](https://huggingface.co/intfloat/multilingual-e5-small), as shown in the upcoming [Performance > Multilingual Similarity](https://huggingface.co/blog/static-embeddings#multilingual-similarity-4) section.

*   [`SentenceTransformer` API Reference](https://sbert.net/docs/package_reference/sentence_transformer/SentenceTransformer.html#sentence_transformers.SentenceTransformer).
*   [`SentenceTransformer.encode` API Reference](https://sbert.net/docs/package_reference/sentence_transformer/SentenceTransformer.html#sentence_transformers.SentenceTransformer.encode).
*   [`SentenceTransformer.similarity` API Reference](https://sbert.net/docs/package_reference/sentence_transformer/SentenceTransformer.html#sentence_transformers.SentenceTransformer.similarity).

### [](https://huggingface.co/blog/static-embeddings#matryoshka-dimensionality-truncation) Matryoshka Dimensionality Truncation
...
### [](https://huggingface.co/blog/static-embeddings#third-party-libraries) Third Party libraries
...
#### [](https://huggingface.co/blog/static-embeddings#langchain) LangChain
...
#### [](https://huggingface.co/blog/static-embeddings#llamaindex) LlamaIndex
...
#### [](https://huggingface.co/blog/static-embeddings#haystack) Haystack
...
#### [](https://huggingface.co/blog/static-embeddings#txtai) txtai
...
## [](https://huggingface.co/blog/static-embeddings#performance) Performance

### [](https://huggingface.co/blog/static-embeddings#english-retrieval-4) English Retrieval
...
##### [](https://huggingface.co/blog/static-embeddings#gpu) GPU

[![Image 6: NanoBEIR performance vs inference speed](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/static-embeddings/nano_beir_vs_speed_gpu.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/static-embeddings/nano_beir_vs_speed_gpu.png)

##### [](https://huggingface.co/blog/static-embeddings#cpu) CPU

[![Image 7: NanoBEIR performance vs inference speed](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/static-embeddings/nano_beir_vs_speed_cpu.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/static-embeddings/nano_beir_vs_speed_cpu.png)
...
#### [](https://huggingface.co/blog/static-embeddings#matryoshka-evaluation) Matryoshka Evaluation
...
[![Image 8: NanoBEIR performance vs Matryoshka dimensionality reduction](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/static-embeddings/nano_beir_matryoshka.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/static-embeddings/nano_beir_matryoshka.png)
...
### [](https://huggingface.co/blog/static-embeddings#multilingual-similarity-4) Multilingual Similarity
...
[![Image 9: STS, Classification, Pair Classification on MTEB](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/static-embeddings/similarity_mteb_eval.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/static-embeddings/similarity_mteb_eval.png)
...
[![Image 10: Texts per second processed](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/static-embeddings/similarity_speed.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/static-embeddings/similarity_speed.png)
...
#### [](https://huggingface.co/blog/static-embeddings#matryoshka-evaluation-1) Matryoshka Evaluation
...
[![Image 11: English STS MTEB performance vs Matryoshka dimensionality reduction](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/static-embeddings/similarity_matryoshka.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/static-embeddings/similarity_matryoshka.png)
...
## [](https://huggingface.co/blog/static-embeddings#conclusion) Conclusion
...
## [](https://huggingface.co/blog/static-embeddings#next-steps) Next Steps
...
## [](https://huggingface.co/blog/static-embeddings#companion-blogposts) Companion Blogposts
...
## [](https://huggingface.co/blog/static-embeddings#acknowledgements) Acknowledgements
