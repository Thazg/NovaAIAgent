...
URL Source: https://huggingface.co/blog/train-sparse-encoder

Published Time: 2025-07-01T00:00:00.590Z
...
[![Image 2: Arthur BRESNU's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/663ce8bfc6827e9ba288eed4/0xrGyvLOq8DtP4TQsesnS.jpeg)](https://huggingface.co/arthurbresnu)
...
## [](https://huggingface.co/blog/train-sparse-encoder#table-of-contents) Table of Contents

*   [What are Sparse Embedding models?](https://huggingface.co/blog/train-sparse-encoder#what-are-sparse-embedding-models)
    *   [Query and Document Expansion](https://huggingface.co/blog/train-sparse-encoder#query-and-document-expansion)
    *   [Why Use Sparse Embedding Models?](https://huggingface.co/blog/train-sparse-encoder#why-use-sparse-embedding-models)

*   [Why Finetune?](https://huggingface.co/blog/train-sparse-encoder#why-finetune)
*   [Training Components](https://huggingface.co/blog/train-sparse-encoder#training-components)
*   [Model](https://huggingface.co/blog/train-sparse-encoder#model)
    *   [Splade](https://huggingface.co/blog/train-sparse-encoder#splade)
    *   [Inference-free Splade](https://huggingface.co/blog/train-sparse-encoder#inference-free-splade)
    *   [Contrastive Sparse Representation (CSR)](https://huggingface.co/blog/train-sparse-encoder#contrastive-sparse-representation-csr)
    *   [Architecture Picker Guide](https://huggingface.co/blog/train-sparse-encoder#architecture-picker-guide)

*   [Dataset](https://huggingface.co/blog/train-sparse-encoder#dataset)
    *   [Data on the Hugging Face Hub](https://huggingface.co/blog/train-sparse-encoder#data-on-the-hugging-face-hub)
    *   [Local Data (CSV, JSON, Parquet, Arrow, SQL)](https://huggingface.co/blog/train-sparse-encoder#local-data-csv-json-parquet-arrow-sql)
    *   [Local Data that requires pre-processing](https://huggingface.co/blog/train-sparse-encoder#local-data-that-requires-pre-processing)
    *   [Dataset Format](https://huggingface.co/blog/train-sparse-encoder#dataset-format)

*   [Loss Function](https://huggingface.co/blog/train-sparse-encoder#loss-function)
*   [Training Arguments](https://huggingface.co/blog/train-sparse-encoder#training-arguments)
*   [Evaluator](https://huggingface.co/blog/train-sparse-encoder#evaluator)
    *   [SparseNanoBEIREvaluator](https://huggingface.co/blog/train-sparse-encoder#sparsenanobeirevaluator)
    *   [SparseEmbeddingSimilarityEvaluator with STSb](https://huggingface.co/blog/train-sparse-encoder#sparseembeddingsimilarityevaluator-with-stsb)
    *   [SparseTripletEvaluator with AllNLI](https://huggingface.co/blog/train-sparse-encoder#sparsetripletevaluator-with-allnli)

*   [Trainer](https://huggingface.co/blog/train-sparse-encoder#trainer)
    *   [Callbacks](https://huggingface.co/blog/train-sparse-encoder#callbacks)
    *   [Multi-Dataset Training](https://huggingface.co/blog/train-sparse-encoder#multi-dataset-training)

*   [Evaluation](https://huggingface.co/blog/train-sparse-encoder#evaluation)
*   [Training Tips](https://huggingface.co/blog/train-sparse-encoder#training-tips)
*   [Vector Database Integration](https://huggingface.co/blog/train-sparse-encoder#vector-database-integration)
*   [Additional Resources](https://huggingface.co/blog/train-sparse-encoder#additional-resources)
    *   [Training Examples](https://huggingface.co/blog/train-sparse-encoder#training-examples)
    *   [Documentation](https://huggingface.co/blog/train-sparse-encoder#documentation)

## [](https://huggingface.co/blog/train-sparse-encoder#what-are-sparse-embedding-models) What are Sparse Embedding models?
...
### [](https://huggingface.co/blog/train-sparse-encoder#query-and-document-expansion) Query and Document Expansion
...
### [](https://huggingface.co/blog/train-sparse-encoder#why-use-sparse-embedding-models) Why Use Sparse Embedding Models?
...
## [](https://huggingface.co/blog/train-sparse-encoder#why-finetune) Why Finetune?
...
## [](https://huggingface.co/blog/train-sparse-encoder#training-components) Training Components

Training Sentence Transformer models involves the following components:

1.   [**Model**](https://huggingface.co/blog/train-sparse-encoder#model): The model to train or finetune, which can be a pre-trained Sparse Encoder model or a base model.
2.   [**Dataset**](https://huggingface.co/blog/train-sparse-encoder#dataset): The data used for training and evaluation.
3.   [**Loss Function**](https://huggingface.co/blog/train-sparse-encoder#loss-function): A function that quantifies the model's performance and guides the optimization process.
4.   [**Training Arguments**](https://huggingface.co/blog/train-sparse-encoder#training-arguments) (optional): Parameters that influence training performance and tracking/debugging.
5.   [**Evaluator**](https://huggingface.co/blog/train-sparse-encoder#evaluator) (optional): A tool for evaluating the model before, during, or after training.
6.   [**Trainer**](https://huggingface.co/blog/train-sparse-encoder#trainer): Brings together the model, dataset, loss function, and other components for training.

Now, let's dive into each of these components in more detail.

## [](https://huggingface.co/blog/train-sparse-encoder#model) Model
...
### [](https://huggingface.co/blog/train-sparse-encoder#splade) Splade
...
### [](https://huggingface.co/blog/train-sparse-encoder#inference-free-splade) Inference-free Splade
...
### [](https://huggingface.co/blog/train-sparse-encoder#contrastive-sparse-representation-csr) Contrastive Sparse Representation (CSR)
...
### [](https://huggingface.co/blog/train-sparse-encoder#architecture-picker-guide) Architecture Picker Guide

If you're unsure which architecture to use, here's a quick guide:

*   Do you want to sparsify an existing Dense Embedding model? If yes, use [**CSR**](https://huggingface.co/blog/train-sparse-encoder#contrastive-sparse-representation-csr).
*   Do you want your query inference to be instantaneous at the cost of slight performance? If yes, use [**Inference-free SPLADE**](https://huggingface.co/blog/train-sparse-encoder#inference-free-splade).
*   Otherwise, use [**SPLADE**](https://huggingface.co/blog/train-sparse-encoder#splade).

## [](https://huggingface.co/blog/train-sparse-encoder#dataset) Dataset
...
### [](https://huggingface.co/blog/train-sparse-encoder#data-on-the-hugging-face-hub) Data on the Hugging Face Hub
...
### [](https://huggingface.co/blog/train-sparse-encoder#local-data-csv-json-parquet-arrow-sql) Local Data (CSV, JSON, Parquet, Arrow, SQL)
...
### [](https://huggingface.co/blog/train-sparse-encoder#local-data-that-requires-pre-processing) Local Data that requires pre-processing
...
### [](https://huggingface.co/blog/train-sparse-encoder#dataset-format) Dataset Format

It's crucial to ensure that your dataset format matches your chosen [loss function](https://huggingface.co/blog/train-sparse-encoder#loss-function). This involves checking two things:

1.   If your loss function requires a _Label_ (as indicated in the [Loss Overview](https://sbert.net/docs/sparse_encoder/loss_overview.html) table), your dataset must have a column named **"label"** or **"score"**.
...
## [](https://huggingface.co/blog/train-sparse-encoder#loss-function) Loss Function
...
## [](https://huggingface.co/blog/train-sparse-encoder#training-arguments) Training Arguments
...
## [](https://huggingface.co/blog/train-sparse-encoder#evaluator) Evaluator
...
### [](https://huggingface.co/blog/train-sparse-encoder#sparsenanobeirevaluator) SparseNanoBEIREvaluator
...
### [](https://huggingface.co/blog/train-sparse-encoder#sparseembeddingsimilarityevaluator-with-stsb) SparseEmbeddingSimilarityEvaluator with STSb
...
### [](https://huggingface.co/blog/train-sparse-encoder#sparsetripletevaluator-with-allnli) SparseTripletEvaluator with AllNLI
...
## [](https://huggingface.co/blog/train-sparse-encoder#trainer) Trainer
...
### [](https://huggingface.co/blog/train-sparse-encoder#callbacks) Callbacks
...
### [](https://huggingface.co/blog/train-sparse-encoder#multi-dataset-training) Multi-Dataset Training
...
## [](https://huggingface.co/blog/train-sparse-encoder#evaluation) Evaluation
...
## [](https://huggingface.co/blog/train-sparse-encoder#training-tips) Training Tips
...
## [](https://huggingface.co/blog/train-sparse-encoder#vector-database-integration) Vector Database Integration
...
### [](https://huggingface.co/blog/train-sparse-encoder#qdrant-integration-example) Qdrant Integration Example
...
### [](https://huggingface.co/blog/train-sparse-encoder#prerequisites) Prerequisites:
...
## [](https://huggingface.co/blog/train-sparse-encoder#additional-resources) Additional Resources

### [](https://huggingface.co/blog/train-sparse-encoder#training-examples) Training Examples
...
### [](https://huggingface.co/blog/train-sparse-encoder#documentation) Documentation
...
### [](https://huggingface.co/blog/train-sparse-encoder#companion-blogposts) Companion Blogposts
