...
URL Source: https://huggingface.co/blog/vdr-2b-multilingual
...
[![Image 1: Marco Cimolai's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/608c698a33a86d1a1a84b4da/9TjyQyys2Zn_9J_ABEb8O.jpeg)](https://huggingface.co/marco)

[![Image 2: Logan Markewich's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/6424f2be988b8b19edba5b73/pgJK3TMNZWJRlAXP3vSCu.jpeg)](https://huggingface.co/cheesyFishes)
...
[![Image 3: image/png](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vdr-2b-multilingual/cover.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vdr-2b-multilingual/cover.png)
...
## [](https://huggingface.co/blog/vdr-2b-multilingual#usage) Usage
...
## [](https://huggingface.co/blog/vdr-2b-multilingual#training-dataset) Training Dataset
...
[![Image 4: image/png](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vdr-2b-multilingual/datapipeline.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vdr-2b-multilingual/datapipeline.png)

### [](https://huggingface.co/blog/vdr-2b-multilingual#data-gathering) Data Gathering
...
### [](https://huggingface.co/blog/vdr-2b-multilingual#synthetic-generation) Synthetic Generation
...
### [](https://huggingface.co/blog/vdr-2b-multilingual#filtering-and-hard-negative-mining) Filtering and Hard-Negative Mining
...
### [](https://huggingface.co/blog/vdr-2b-multilingual#download) Download
...
## [](https://huggingface.co/blog/vdr-2b-multilingual#evaluations) Evaluations

[![Image 5: image/png](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vdr-2b-multilingual/ndcgtop.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vdr-2b-multilingual/ndcgtop.png)
...
The multilingual model outperforms the base model in every language and every page type, on average by +2.3%. On the ViDoRe benchmark, it also performs slightly better (+0.5%). Our fine-tuned `vdr-2b-multi-v1` makes big leaps in performance, especially in non-English visual-only or mixed pages. See for example the +6.33% NDCG@5 improvement for German visual-only retrieval over the base model.
...
### [](https://huggingface.co/blog/vdr-2b-multilingual#faster-inference) Faster Inference

[![Image 6: image/png](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vdr-2b-multilingual/efficiency.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vdr-2b-multilingual/efficiency.png)
...
### [](https://huggingface.co/blog/vdr-2b-multilingual#cross-lingual-retrieval) Cross-Lingual Retrieval
...
### [](https://huggingface.co/blog/vdr-2b-multilingual#mrl-and-binary-embeddings) MRL and Binary Embeddings

This model is trained using Matryoshka Representation Learning (MRL). The loss function used during training is calibrated to track performance across all these dimensions, leading the model to frontload the most important identifying information. This effectively allows you to shrink the embedding dimensions according to your scale and budget. To learn more about MRL, [this blog post](https://huggingface.co/blog/matryoshka) by Hugging Face explains it very well.
...
#### [](https://huggingface.co/blog/vdr-2b-multilingual#ndcg5-float) NDCG@5 (float)
...
#### [](https://huggingface.co/blog/vdr-2b-multilingual#ndcg5-binary) NDCG@5 (binary)
...
## [](https://huggingface.co/blog/vdr-2b-multilingual#conclusions-and-next-steps) Conclusions and Next Steps
...
## [](https://huggingface.co/blog/vdr-2b-multilingual#links) Links
