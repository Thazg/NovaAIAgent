...
URL Source: https://huggingface.co/blog/embeddinggemma

Published Time: 2025-09-04T00:00:00.622Z
...
[![Image 3: Alvaro Bartolome's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/60f0608166e5701b80ed3f02/H9LNnlf0W4fiOJhQMxnbW.jpeg)](https://huggingface.co/alvarobartt)

[![Image 4: Aritra Roy Gosthipaty's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/608aabf24955d2bfc3cd99c6/-YxmtpzEmf3NKOTktODRP.jpeg)](https://huggingface.co/ariG23498)
...
## [](https://huggingface.co/blog/embeddinggemma#tldr) TL;DR
...
## [](https://huggingface.co/blog/embeddinggemma#table-of-contents) Table of Contents

*   [Introduction](https://huggingface.co/blog/embeddinggemma#introduction)
*   [Evaluation](https://huggingface.co/blog/embeddinggemma#evaluation)
*   [Demo](https://huggingface.co/blog/embeddinggemma#demo)
*   [Usage](https://huggingface.co/blog/embeddinggemma#usage)
    *   [Sentence Transformers](https://huggingface.co/blog/embeddinggemma#sentence-transformers)
        *   [Retrieval](https://huggingface.co/blog/embeddinggemma#retrieval)

    *   [LangChain](https://huggingface.co/blog/embeddinggemma#langchain)
    *   [LlamaIndex](https://huggingface.co/blog/embeddinggemma#llamaindex)
    *   [Haystack](https://huggingface.co/blog/embeddinggemma#haystack)
    *   [txtai](https://huggingface.co/blog/embeddinggemma#txtai)
    *   [Transformers.js](https://huggingface.co/blog/embeddinggemma#transformersjs)
    *   [Text Embeddings Inference](https://huggingface.co/blog/embeddinggemma#text-embeddings-inference)
    *   [ONNX Runtime](https://huggingface.co/blog/embeddinggemma#onnx-runtime)

*   [Finetuning](https://huggingface.co/blog/embeddinggemma#finetuning)
    *   [Full Finetuning Script](https://huggingface.co/blog/embeddinggemma#full-finetuning-script)
    *   [Training](https://huggingface.co/blog/embeddinggemma#training)
    *   [Finetuned Evaluation](https://huggingface.co/blog/embeddinggemma#finetuned-evaluation)

*   [Further Reading](https://huggingface.co/blog/embeddinggemma#further-reading)

## [](https://huggingface.co/blog/embeddinggemma#introduction) Introduction
...
## [](https://huggingface.co/blog/embeddinggemma#evaluation) Evaluation
...
| --- | --- |
| ![Image 7](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/embeddinggemma/embeddinggemma-300m-mteb-multilingual.png) | ![Image 8](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/embeddinggemma/embeddinggemma-300m-mteb-eng.png) |
...
## [](https://huggingface.co/blog/embeddinggemma#demo) Demo

_The [demo](https://huggingface.co/spaces/webml-community/semantic-galaxy) can also be experienced in full screen._

[Video 3](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/embeddinggemma/semantic_galaxy.mp4)
_Experience the [demo](https://huggingface.co/spaces/webml-community/semantic-galaxy) yourself on a Desktop device._

## [](https://huggingface.co/blog/embeddinggemma#usage) Usage
...
### [](https://huggingface.co/blog/embeddinggemma#sentence-transformers) Sentence Transformers
...
#### [](https://huggingface.co/blog/embeddinggemma#retrieval) Retrieval
...
### [](https://huggingface.co/blog/embeddinggemma#langchain) LangChain
...
### [](https://huggingface.co/blog/embeddinggemma#llamaindex) LlamaIndex
...
### [](https://huggingface.co/blog/embeddinggemma#haystack) Haystack
...
### [](https://huggingface.co/blog/embeddinggemma#txtai) txtai
...
### [](https://huggingface.co/blog/embeddinggemma#transformersjs) Transformers.js
...
### [](https://huggingface.co/blog/embeddinggemma#text-embeddings-inference) Text Embeddings Inference
...
### [](https://huggingface.co/blog/embeddinggemma#onnx-runtime) ONNX Runtime
...
## [](https://huggingface.co/blog/embeddinggemma#finetuning) Finetuning
...
### [](https://huggingface.co/blog/embeddinggemma#full-finetuning-script) Full Finetuning Script
...
### [](https://huggingface.co/blog/embeddinggemma#training) Training
...
### [](https://huggingface.co/blog/embeddinggemma#finetuned-evaluation) Finetuned Evaluation
...
## [](https://huggingface.co/blog/embeddinggemma#further-reading) Further Reading
...
### [](https://huggingface.co/blog/embeddinggemma#companion-sentence-transformers-blogposts) Companion Sentence Transformers blogposts
