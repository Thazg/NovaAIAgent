...
URL Source: https://huggingface.co/blog/matryoshka

Published Time: 2024-02-23T00:00:00.342Z
...
[![Image 2: Joshua's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/61b253b7ac5ecaae3d1efe0c/hwiQ0uvz3t-L5a-NtBIO6.png)](https://huggingface.co/Xenova)

[![Image 3: Omar Sanseviero's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/6032802e1f993496bc14d9e3/w6hr-DEQot4VVkoyRIBiy.png)](https://huggingface.co/osanseviero)

*   [Table of Contents](https://huggingface.co/blog/matryoshka#table-of-contents "Table of Contents")

*   [Understanding Embeddings](https://huggingface.co/blog/matryoshka#understanding-embeddings "Understanding Embeddings")

*   [🪆 Matryoshka Embeddings](https://huggingface.co/blog/matryoshka#%F0%9F%AA%86-matryoshka-embeddings "🪆 Matryoshka Embeddings")

*   [🪆 Matryoshka Dolls](https://huggingface.co/blog/matryoshka#%F0%9F%AA%86-matryoshka-dolls "🪆 Matryoshka Dolls")

*   [Why would you use 🪆 Matryoshka Embedding models?](https://huggingface.co/blog/matryoshka#why-would-you-use-%F0%9F%AA%86-matryoshka-embedding-models "Why would you use 🪆 Matryoshka Embedding models?")

*   [How are 🪆 Matryoshka Embedding models trained?](https://huggingface.co/blog/matryoshka#how-are-%F0%9F%AA%86-matryoshka-embedding-models-trained "How are 🪆 Matryoshka Embedding models trained?")
    *   [Theoretically](https://huggingface.co/blog/matryoshka#theoretically "Theoretically")

    *   [In Sentence Transformers](https://huggingface.co/blog/matryoshka#in-sentence-transformers "In Sentence Transformers")

*   [How do I use 🪆 Matryoshka Embedding models?](https://huggingface.co/blog/matryoshka#how-do-i-use-%F0%9F%AA%86-matryoshka-embedding-models "How do I use 🪆 Matryoshka Embedding models?")
    *   [Theoretically](https://huggingface.co/blog/matryoshka#theoretically-1 "Theoretically")

    *   [In Sentence Transformers](https://huggingface.co/blog/matryoshka#in-sentence-transformers-1 "In Sentence Transformers")

*   [Results](https://huggingface.co/blog/matryoshka#results "Results")

*   [Demo](https://huggingface.co/blog/matryoshka#demo "Demo")

*   [References](https://huggingface.co/blog/matryoshka#references "References")

*   [Companion Blogposts](https://huggingface.co/blog/matryoshka#companion-blogposts "Companion Blogposts")
...
## [](https://huggingface.co/blog/matryoshka#table-of-contents) Table of Contents

*   [Understanding Embeddings](https://huggingface.co/blog/matryoshka#understanding-embeddings)
*   [🪆 Matryoshka Embeddings](https://huggingface.co/blog/matryoshka#%F0%9F%AA%86-matryoshka-embeddings)
*   [🪆 Matryoshka Dolls](https://huggingface.co/blog/matryoshka#%F0%9F%AA%86-matryoshka-dolls)
*   [Why would you use 🪆 Matryoshka Embedding models?](https://huggingface.co/blog/matryoshka#why-would-you-use-%F0%9F%AA%86-matryoshka-embedding-models)
*   [How are 🪆 Matryoshka Embedding models trained?](https://huggingface.co/blog/matryoshka#how-are-%F0%9F%AA%86-matryoshka-embedding-models-trained)
    *   [Theoretically](https://huggingface.co/blog/matryoshka#theoretically)
    *   [In Sentence Transformers](https://huggingface.co/blog/matryoshka#in-sentence-transformers)

*   [How do I use 🪆 Matryoshka Embedding models?](https://huggingface.co/blog/matryoshka#how-do-i-use-%F0%9F%AA%86-matryoshka-embedding-models)
    *   [Theoretically](https://huggingface.co/blog/matryoshka#theoretically-1)
    *   [In Sentence Transformers](https://huggingface.co/blog/matryoshka#in-sentence-transformers-1)

*   [Results](https://huggingface.co/blog/matryoshka#results)
*   [Demo](https://huggingface.co/blog/matryoshka#demo)
*   [References](https://huggingface.co/blog/matryoshka#references)

## [](https://huggingface.co/blog/matryoshka#understanding-embeddings) Understanding Embeddings
...
[![Image 4: embedding model](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/matryoshka/embedding_model.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/matryoshka/embedding_model.png)
...
[![Image 5: embedding similarity](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/matryoshka/embedding_similarity.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/matryoshka/embedding_similarity.png)
...
## [](https://huggingface.co/blog/matryoshka#%F0%9F%AA%86-matryoshka-embeddings) 🪆 Matryoshka Embeddings
...
[![Image 6: matryoshka model](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/matryoshka/matryoshka_model.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/matryoshka/matryoshka_model.png)
...
## [](https://huggingface.co/blog/matryoshka#%F0%9F%AA%86-matryoshka-dolls) 🪆 Matryoshka Dolls
...
[![Image 7: matryoshka models](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/matryoshka/matryoshka-small.gif)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/matryoshka/matryoshka-small.gif)

## [](https://huggingface.co/blog/matryoshka#why-would-you-use-%F0%9F%AA%86-matryoshka-embedding-models) Why would you use 🪆 Matryoshka Embedding models?
...
## [](https://huggingface.co/blog/matryoshka#how-are-%F0%9F%AA%86-matryoshka-embedding-models-trained) How are 🪆 Matryoshka Embedding models trained?

### [](https://huggingface.co/blog/matryoshka#theoretically) Theoretically
...
### [](https://huggingface.co/blog/matryoshka#in-sentence-transformers) In Sentence Transformers
...
*   **[matryoshka_sts.py](https://github.com/UKPLab/sentence-transformers/blob/master/examples/sentence_transformer/training/matryoshka/matryoshka_sts.py)**: This example uses the `CoSENTLoss` with `MatryoshkaLoss` to train an embedding model on the training set of the `STSBenchmark` dataset. It is an adaptation of the [STS](https://huggingface.co/sts/README) documentation.

## [](https://huggingface.co/blog/matryoshka#how-do-i-use-%F0%9F%AA%86-matryoshka-embedding-models) How do I use 🪆 Matryoshka Embedding models?

### [](https://huggingface.co/blog/matryoshka#theoretically-1) Theoretically
...
### [](https://huggingface.co/blog/matryoshka#in-sentence-transformers-1) In Sentence Transformers
...
## [](https://huggingface.co/blog/matryoshka#results) Results
...
[![Image 8: results](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/matryoshka/results.png)](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/matryoshka/results.png)
...
## [](https://huggingface.co/blog/matryoshka#demo) Demo
...
## [](https://huggingface.co/blog/matryoshka#references) References
...
## [](https://huggingface.co/blog/matryoshka#companion-blogposts) Companion Blogposts
