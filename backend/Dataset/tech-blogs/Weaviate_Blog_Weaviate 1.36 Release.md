...
URL Source: https://weaviate.io/blog/weaviate-1-36-release

Published Time: 2026-03-03T00:00:00.000Z
...
![Image 1: Weaviate 1.36 is released](https://weaviate.io/assets/images/hero-20f6a44989b1af4eb822f44168c6731d.png)

*   [HFresh (Preview)](https://weaviate.io/blog/weaviate-1-36-release#hfresh-preview)
*   [Server-side Batching - General Availability](https://weaviate.io/blog/weaviate-1-36-release#server-side-batching---general-availability)
*   [Object TTL - General Availability](https://weaviate.io/blog/weaviate-1-36-release#object-ttl---general-availability)
*   [Async Replication Improvements - General Availability](https://weaviate.io/blog/weaviate-1-36-release#async-replication-improvements---general-availability)
*   [Alter Schema: Drop Inverted Indices - General Availability](https://weaviate.io/blog/weaviate-1-36-release#alter-schema-drop-inverted-indices---general-availability)
*   [Backup Restoration Cancellation - General Availability](https://weaviate.io/blog/weaviate-1-36-release#backup-restoration-cancellation---general-availability)
*   [Multiple performance improvements and fixes](https://weaviate.io/blog/weaviate-1-36-release#multiple-performance-improvements-and-fixes)
*   [Community contributions](https://weaviate.io/blog/weaviate-1-36-release#community-contributions)

## HFresh (Preview)[​](https://weaviate.io/blog/weaviate-1-36-release#hfresh-preview "Direct link to HFresh (Preview)")
...
### Key Capabilities[​](https://weaviate.io/blog/weaviate-1-36-release#key-capabilities "Direct link to Key Capabilities")
...
### Tuning Search Quality[​](https://weaviate.io/blog/weaviate-1-36-release#tuning-search-quality "Direct link to Tuning Search Quality")
...
### Limitations[​](https://weaviate.io/blog/weaviate-1-36-release#limitations "Direct link to Limitations")

*   Only supports `cosine` and `l2-squared` distance metrics
*   Preview feature — the API and behavior may change in future releases

### When to Consider HFresh[​](https://weaviate.io/blog/weaviate-1-36-release#when-to-consider-hfresh "Direct link to When to Consider HFresh")
...
## Server-side Batching - General Availability[​](https://weaviate.io/blog/weaviate-1-36-release#server-side-batching---general-availability "Direct link to Server-side Batching - General Availability")
...
### Usage[​](https://weaviate.io/blog/weaviate-1-36-release#usage "Direct link to Usage")
...
`collection = client.collections.get("Articles")with collection.batch.stream() as batch:    for item in data:        batch.add_object(properties=item)        if batch.number_errors > 10:            print("Batch import stopped due to excessive errors.")            break`

Related resources

## Object TTL - General Availability[​](https://weaviate.io/blog/weaviate-1-36-release#object-ttl---general-availability "Direct link to Object TTL - General Availability")
...
### How It Works[​](https://weaviate.io/blog/weaviate-1-36-release#how-it-works "Direct link to How It Works")
...
### Configuration Examples[​](https://weaviate.io/blog/weaviate-1-36-release#configuration-examples "Direct link to Configuration Examples")

`import datetimefrom weaviate.classes.config import Configure, Property, DataType# Strategy 1: Expire 24 hours after creationclient.collections.create(    name="SessionLogs",    properties=[        Property(name="data", data_type=DataType.TEXT),    ],    object_ttl_config=Configure.ObjectTTL.delete_by_creation_time(        time_to_live=datetime.timedelta(hours=24),        filter_expired_objects=True,    ),)# Strategy 2: Expire 7 days after last updateclient.collections.create(    name="CacheData",    properties=[        Property(name="data", data_type=DataType.TEXT),    ],    object_ttl_config=Configure.ObjectTTL.delete_by_update_time(        time_to_live=datetime.timedelta(days=7),        filter_expired_objects=True,    ),)# Strategy 3: Expire 30 days after a date propertyclient.collections.create(    name="Events",    properties=[        Property(name="event_date", data_type=DataType.DATE),        Property(name="title", data_type=DataType.TEXT),    ],    object_ttl_config=Configure.ObjectTTL.delete_by_date_property(        property_name="event_date",        ttl_offset=datetime.timedelta(days=30),    ),)`

Related resources

## Async Replication Improvements - General Availability[​](https://weaviate.io/blog/weaviate-1-36-release#async-replication-improvements---general-availability "Direct link to Async Replication Improvements - General Availability")
...
### Collection-Level Configuration[​](https://weaviate.io/blog/weaviate-1-36-release#collection-level-configuration "Direct link to Collection-Level Configuration")
...
## Alter Schema: Drop Inverted Indices - General Availability[​](https://weaviate.io/blog/weaviate-1-36-release#alter-schema-drop-inverted-indices---general-availability "Direct link to Alter Schema: Drop Inverted Indices - General Availability")
...
### Usage[​](https://weaviate.io/blog/weaviate-1-36-release#usage-1 "Direct link to Usage")
...
## Backup Restoration Cancellation - General Availability[​](https://weaviate.io/blog/weaviate-1-36-release#backup-restoration-cancellation---general-availability "Direct link to Backup Restoration Cancellation - General Availability")
...
### When Can a Restore Be Cancelled?[​](https://weaviate.io/blog/weaviate-1-36-release#when-can-a-restore-be-cancelled "Direct link to When Can a Restore Be Cancelled?")
...
### Usage[​](https://weaviate.io/blog/weaviate-1-36-release#usage-2 "Direct link to Usage")

`result = client.backup.cancel(    backup_id="my-very-first-backup",    backend="filesystem",    backup_location=BackupLocation.FileSystem(path="/tmp/weaviate-backups"),    operation="restore",)`

Related resources

## Multiple Performance Improvements and Fixes[​](https://weaviate.io/blog/weaviate-1-36-release#multiple-performance-improvements-and-fixes "Direct link to Multiple Performance Improvements and Fixes")
...
## Summary[​](https://weaviate.io/blog/weaviate-1-36-release#summary "Direct link to Summary")
...
## Ready to start building?[​](https://weaviate.io/blog/weaviate-1-36-release#ready-to-start-building "Direct link to Ready to start building?")
