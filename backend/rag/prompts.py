...
no_context_template = (
    ...
    "1. State that no relevant documents were found (one sentence).\n"
    "2. Suggest two options (use bullet points, each on its own line):\n"
    ...
    "3. Keep it concise. Do NOT make up information.\n\n"
    "Instructions:\n{instructions}\n\n"
    "History:\n{history}\n\n"
    "Question: {question}\n\n"
    "Answer:"
...
empty_db_template = (
    ...
    "Your response format:\n"
    "1. State that the knowledge base is empty (one sentence).\n"
    ...
    "4. Keep it concise (2-3 sentences). Use line breaks between bullet points. "
